  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (id) {
        ...
        const sequence = (proposals.length + 49).toString().padStart(3, '0');
        setFormData(prev => ({
          ...prev,
          code: `${year}${sequence}`,
      ...
      <div className="bg-white rounded-[40px] shadow-sm border border-slate-100 overflow-hidden flex flex-col">
                            ...
                            <>
                              <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  <div className="md:col-span-2">
                                    <span className="text-slate-500 font-black uppercase text-[11px] tracking-widest">{activeProp.pricingModel === 'Venda'? 'Valor de Venda:':'Valor do Contrato (Mensal):'}</span>'Valor do Contrato (Mensal)</label>
        ...
        <div className="bg-slate-50 p-8 flex justify-between border-t border-slate-100">
          ...
          <button
            ...
            disabled={isSaving}
            className="bg-blue-600 text-white px-14 py-4 rounded-2xl font-black hover:bg-blue-700 transition flex items-center gap-2 shadow-xl shadow-blue-100 uppercase text-xs tracking-widest disabled:opacity-60"
          >
